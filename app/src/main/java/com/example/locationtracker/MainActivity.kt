...
import com.example.locationtracker.service.ForegroundOnlyLocationService
import com.example.locationtracker.utility.SharedPreferenceUtility
import com.example.locationtracker.utility.toText
...
class MainActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.foregroundOnlyLocationButton.setOnClickListener {
            val enabled = sharedPreferences.getBoolean(
                SharedPreferenceUtility.KEY_FOREGROUND_ENABLED, false)
    ...
    override fun onStart() {
        ...
        updateButtonState(
            sharedPreferences.getBoolean(SharedPreferenceUtility.KEY_FOREGROUND_ENABLED, false)
        )
    ...
    override fun onResume() {
        super.onResume()
        LocalBroadcastManager.getInstance(this).registerReceiver(foregroundOnlyBroadcastReceiver,
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        ...
        if (key == SharedPreferenceUtility.KEY_FOREGROUND_ENABLED) {
                    ...
                    Snackbar.make(
                        ...
                        .setAction(R.string.settings) {
                            ...
                            val uri = Uri.fromParts(
                                "package",
                                com.example.locationtracker.BuildConfig.APPLICATION_ID,
                                null
                            )
                            intent.data = uri
    ...
    private fun updateButtonState(trackingLocation: Boolean) {
        if (trackingLocation) {
            binding.foregroundOnlyLocationButton.text = getString(R.string.stop_location_updates_button_text)
        } else {
            binding.foregroundOnlyLocationButton.text = getString(R.string.start_location_updates_button_text)
        }
    }
