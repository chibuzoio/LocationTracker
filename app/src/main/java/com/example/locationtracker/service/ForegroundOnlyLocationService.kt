...
class ForegroundOnlyLocationService : Service() {
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        // we do nothing.
        if (!configurationChange && SharedPreferenceUtility.getLocationTrackingPref(this)) {
    ...
    fun subscribeToLocationUpdates() {
        ...
        SharedPreferenceUtility.saveLocationTrackingPref(this, true)
        ...
        try {
            ...
            SharedPreferenceUtility.saveLocationTrackingPref(this, false)
